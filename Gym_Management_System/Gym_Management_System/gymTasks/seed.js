...
const activityPermission7 = authentication.addPermission("addActivity","/activity/add","TRAINER");
...
const membershipPermission7 = authentication.addPermission("addMembership","/membership/add","TRAINER");
...
const noticePermission7 = authentication.addPermission("addNotice","/notice/add","TRAINER");
const noticePermission8 = authentication.addPermission("notice","/notice","gymMember");
const noticePermission5 = authentication.addPermission("viewNotice","/notice/view","gymMember");
...
const trainerPermission6 = authentication.addPermission("trainer","/trainer","TRAINER");
const trainerPermission7 = authentication.addPermission("addTrainer","/trainer/add","TRAINER");
const trainerPermission8 = authentication.addPermission("trainer","/trainer","gymMember");
...
const workoutActivityPermission8 = authentication.addPermission("viewWorkoutActivity","/workoutActivity/view","TRAINER");
...
let userInfo1 ={
   ...
   const userAdded = await users.getUserNameByRole("ADMIN");
   const username = await users.getUserByUsername(userAdded);
