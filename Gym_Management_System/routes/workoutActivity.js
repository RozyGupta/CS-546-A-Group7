...
router.post("/add/", authRoute("addWorkoutActivity"), async (req, res) => {
    ...
    if (endDate < startDate) {
        res.render("addWorkoutActivity", { layout: layout, title: "Workout Activity", userName: userName, activity: allActivities, userId: userId, message: "End date can not be earlier than start date!", title: "addWorkoutActivity" });
        return;
    }
    if (!level) {
        res.render("addWorkoutActivity", { layout: layout, title: "Workout Activity", userName: userName, activity: allActivities, userId: userId, message: "Please provide level", title: "addWorkoutActivity" });
        return;
    }

    if (!description) {
        res.render("addWorkoutActivity", { userName: userName, userId: userId, activity: allActivities, title: "Workout Activity", layout: layout, message: "Please provide description", title: "addworkoutActivity" });
        return;
    }

    if (!startdate) {
        res.render("addWorkoutActivity", { userName: userName, userId: userId, activity: allActivities, title: "Workout Activity", layout: layout, message: "Please provide startdate", title: "addWorkoutActivity" });
        return;
    }
    if (!enddate) {
        res.render("addWorkoutActivity", { userName: userName, userId: userId, activity: allActivities, title: "Workout Activity", layout: layout, message: "Please provide enddate", title: "addWorkoutActivity" });
        return;
    }
    if (!days) {
        res.render("addWorkoutActivity", { userName: userName, userId: userId, activity: allActivities, title: "Workout Activity", layout: layout, message: "Please provide days", title: "addWorkoutActivity" });
        return;
    }
    if (!activity) {
        res.render("addWorkoutActivity", { userName: userName, userId: userId, activity: allActivities, title: "Workout Activity", layout: layout, message: "Please provide activity", title: "addWorkoutActivity" });
        return;
    }
    if (!sets) {
        res.render("addWorkoutActivity", { userName: userName, userId: userId, activity: allActivities, layout: layout, title: "Workout Activity", message: "Please provide sets", title: "addWorkoutActivity" });
        return;
    }
    if (!weight) {
        res.render("addWorkoutActivity", { userName: userName, userId: userId, activity: allActivities, layout: layout, title: "Workout Activity", message: "Please provide weight", title: "addWorkoutActivity" });
        return;
    }
    if (!repetitions) {
        res.render("addWorkoutActivity", { userName: userName, userId: userId, activity: allActivities, title: "Workout Activity", layout: layout, message: "Please provide repetitions", title: "addWorkoutActivity" });
        return;
    }
